...
$query = mysql_query("select * from mapel where kd_mapel='$id'") or die(mysql_error());
	...
	<div id="page">
		<div id="sidebar-bg">
			...
			<h2>Form Edit Data Mata Pelajaran</h2>
				<form name="input_data" action="update_mapel.php" method="post">
				<table border="0" cellpadding="5" cellspacing="0">
					<tbody>
						...
						<tr class='light'>
							<td>Nama Mapel</td>
							<td>:</td>
							<td><input type="text" name="nm_mapel" maxlength="20" required="required" value="<?php echo $data['nm_mapel']; ?>" /></td>
						</tr>
						<tr class='dark'>
							<td>NIP</td>
							<td>:</td>
							<td><input type="text" name="nip"  required="required" value="<?php echo $data['nip']; ?>" /></td>
						</tr>
						<tr class='light'>
